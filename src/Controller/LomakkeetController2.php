...
class LomakkeetController2 extends AbstractController{


    /**
     * @Route("lomakkeet/lomake2", name="omalomake2")
     */
    public function lomake1(Request $request){
        ...
        $form = $this->createFormBuilder($henkilo)
            ->setAction($this->generateUrl("omalomake2"))
            ...
            if($form->isSubmitted()){
                ...
                return $this->render('lomakkeet/naytalomake2.html.twig', [
                    'henkilo' => $henkilo,
                ]);
            }

        return $this->render("lomakkeet\lomake2.html.twig", [
